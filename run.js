...
//                      alert('error');
	...
	app.run({
		'callback': f,
		'context': this,
		'host': getURLParameter('host') || document.domain,
		'port': getURLParameter('port') || window.location.port+'?token='+getURLParameter('token'),
		'protocol': getURLParameter('protocol') || 'ws',
		'token': getURLParameter('token') || 'tokentest',
